...
[![cran
checks](https://badges.cranchecks.info/worst/pangaear.svg)](https://cloud.r-project.org/web/checks/check_results_pangaear.html)
...
[![rstudio mirror
downloads](https://cranlogs.r-pkg.org/badges/pangaear)](https://github.com/r-hub/cranlogs.app)
[![cran
version](https://www.r-pkg.org/badges/version/pangaear)](https://cran.r-project.org/package=pangaear)
...
This package offers tools to interact with the PANGAEA Database,
including functions for searching for data, fetching datasets by dataset
ID, and working with the PANGAEA OAI-PMH service.
...
- [OAI-PMH
  Spec](http://www.openarchives.org/OAI/openarchivesprotocol.md)
...
- Please [report any issues or
  bugs](https://github.com/ropensci/pangaear/issues).
- License: MIT
- Get citation information for `pangaear` in R doing
  `citation(package = 'pangaear')`
